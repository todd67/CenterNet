  ...
  def __init__(self):
    ...
    self.parser.add_argument('--no_color_aug', action='store_true',
                             help='not use the color augmenation '
                                  'from CornerNet')
    self.parser.add_argument('--train_db', type=str,
                             help='train ViDataset name')
    self.parser.add_argument('--val_db', type=str,
                             help='tval ViDataset name')
    self.parser.add_argument('--test_db', type=str,
                             help='test ViDataset name')
    # multi_pose
